...
pub fn process_input(
    ...
    for input in ev_reader.iter() {
        ...
        if enemy.start_tolerance <= 0.0 {
         ...
         /*else if enemy.start_tolerance >= 50.0 && CUR_TURN == MAX_TURNS{
            println!("made it in here");
        ...
        unsafe {    
            ...
            else if (player_sent == false) { // TODO: CASE REACHED FINAL TURN AND PLAYER DIDN'T TRIGGER FIGHT
